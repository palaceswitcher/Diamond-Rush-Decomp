...
public final class cGame extends GameCanvas implements Runnable {
	...
	public static final short[][] field_561;
	// $FF: renamed from: d int[]
									...
									if (var6 >= 0 && var6 < 3) {
										...
										switch (var6) {
											...
											case 1:
												...
												return;
											case 2:
												field_348 = new int[this.currentLevelWidth][this.currenLevelHeight];
												field_350 = new byte[this.currentLevelWidth][this.currenLevelHeight];
												field_351 = new byte[this.currentLevelWidth][this.currenLevelHeight];
												field_349 = new int[this.currentLevelWidth][this.currenLevelHeight];
												if (field_344 != null) {
			...
			switch (var1) {
				...
				case 4:
					...
					for(int i = 0; i < var6; i++) {
						...
						byte var9 = 0;
						byte var10 = 0;
						int var11 = method_366(this.field_306);
						int var12 = method_366(this.field_306);
	...
	private int method_119(int var1) {
		int var2;
		return (var2 = method_120(var1) + 1) >= 0 && var2 <= field_330.length ? field_330[method_120(var1) + 1] : 0;
	}
	...
	// $FF: renamed from: M () void
	private void method_130() throws Exception {
		field_398 = -1;
		field_367 = false;
		this.field_100 = true;
		this.field_207 = 0;
		...
		while(!var2) {
			...
			for(byte[] buf = new byte[4]; var4 < var3 && !var2; var4++) {
				...
				if (var4 != this.currentLevel) {
					...
					this.currenLevelHeight = levelHeight;
					field_334 = (byte[][])null;
					field_336 = (byte[][])null;
					field_332 = (int[][])null;
					System.gc();
					field_334 = new byte[this.currentLevelWidth][this.currenLevelHeight];
					field_336 = new byte[this.currentLevelWidth][this.currenLevelHeight];
					field_332 = new int[this.currentLevelWidth][this.currenLevelHeight];
					buf = new byte[this.currentLevelWidth * this.currenLevelHeight];
					this.field_306.read(buf);

					for(int c = 0; c < this.currentLevelWidth; c++) {
						for(int r = 0; r < this.currenLevelHeight; r++) {
							field_334[c][r] = buf[c + r * this.currentLevelWidth];
						}
					}

					field_335 = new byte[this.currentLevelWidth][this.currenLevelHeight];
					field_333 = new int[this.currentLevelWidth][this.currenLevelHeight];
					this.field_306.read(buf);

					for(int var10 = 0; var10 < this.currentLevelWidth; ++var10) {
						for(int var12 = 0; var12 < this.currenLevelHeight; ++var12) {
							field_333[var10][var12] = buf[var10 + var12 * this.currentLevelWidth];
						}
					}

					this.field_306.read(buf);

					for(int var11 = 0; var11 < this.currentLevelWidth; ++var11) {
						for(int var13 = 0; var13 < this.currenLevelHeight; ++var13) {
							field_332[var11][var13] = buf[var11 + var13 * this.currentLevelWidth];
						}
					}
	...
	private void method_143() {
		...
		var10000.method_13(var10001, var10002, var10003, var10004, var10005);
		this.method_191();
	}
	...
	private void method_150(int var1, int var2, int var3, int var4, boolean var5) {
		...
		this.field_282 = var2 / 24 - 1;

		for(int var11 = var2; var11 <= var4; var11 += 24) {
			this.field_271 = var9 - 24;
			this.field_281 = var1 / 24 - 1;
			this.field_272 += 24;
			++this.field_282;
			...
			for(int var12 = var1; var12 <= var3; var12 += 24) {
				this.field_271 += 24;
				++this.field_281;
				...
				if (this.field_281 >= 0 && this.field_281 < this.currentLevelWidth && this.field_282 >= 0 && this.field_282 < this.currenLevelHeight) {
					this.field_283 = field_334[this.field_281][this.field_282];
					this.field_284 = field_332[this.field_281][this.field_282] & 255;
						...
						label150: {
							...
							switch (this.field_284) {
								...
								case 15:
									...
									this.field_214 = 14;
									var10000 = this;
									var10001 = 0 + this.field_310 * 5 / 10;
									break;
								case 16:
									if (this.field_310 != 9) {
										break label150;
						...
						label109: {
							...
							if ((var13 = (byte)(this.field_283 - 80)) >= 0) {
								...
								switch (this.field_283) {
									case 0:
										if (field_335[this.field_281][this.field_282] == 0 && (field_500 == null || field_500[this.field_281][this.field_282] == 0)) {
											this.method_192();
										}
										break label109;
									case 1:
	...
	private void method_151(Graphics var1) {
		for(int var2 = -1; var2 < 12; ++var2) {
			for(int var3 = -1; var3 < 12; ++var3) {
				this.field_281 = var3 + this.field_402;
				this.field_282 = var2 + this.field_403;
				if (this.field_281 >= 0 && this.field_281 < this.currentLevelWidth && this.field_282 >= 0 && this.field_282 < this.currenLevelHeight) {
					this.field_283 = field_334[this.field_281][this.field_282];
					this.field_284 = field_332[this.field_281][this.field_282] & 255;
						...
						label193: {
							label170: {
								...
								switch (this.field_284) {
									case 3:
										int var4;
										if ((var4 = (field_332[this.field_281][this.field_282] >> 8) - 1) >= 0) {
											this.field_214 = 12;
					...
					if (this.field_283 != -1) {
							...
							label194: {
								...
								switch (this.field_283) {
									...
									case 8:
										...
										break;
									case 1:
										if ((field_333[this.field_281][this.field_282] & Integer.MIN_VALUE) != 0 || this.field_292 != 0) {
											var7 = this;
											break;
										}
									case 2:
									...
									case 9:
										this.method_192();
										if ((field_333[this.field_281][this.field_282] & 264241152) == 138412032) {
						...
						if (this.field_216 != -1) {
							...
							if (this.field_281 == this.field_359 && this.field_282 == this.field_360) {
								field_364 = field_324;
		...
		if (field_367) {
			...
			for(int var17 = -1; var17 < 12; ++var17) {
				for(int var24 = -1; var24 < 12; ++var24) {
					...
					if (var37 >= 0 && var37 < this.currentLevelWidth && var39 >= 0 && var39 < this.currenLevelHeight) {
			...
			if (this.field_462 != null) {
				this.field_170 = true;
				method_405(var1, field_320[41], this.field_462, 120, 263, 33, 4, true);
			}
	...
	private void method_154() {
		...
		int var5 = (field_226 >> 1) % field_320[2].method_4(1);
		...
		for(int var6 = 0; var6 < field_192.length; var6 += 3) {
			...
			if ((var9 = (var8 = field_192[var6 + 2]) * 24) > var1 && var9 < var2) {
				...
				if (var12 >= var3 && var12 <= var4 || var13 >= var3 && var13 <= var4 || var12 <= var3 && var13 >= var4) {
					...
					var10000.method_7(var10001, var10002, var10003, var10004, var10005, var10006, 0, 0);
				}
			}
		}
	...
	private void method_155() {
		int var1;
		if (((var1 = field_333[this.field_281][this.field_282]) & 8) == 0) {
			...
			byte var4 = field_335[this.field_281][this.field_282];
	...
	private void method_156() {
		if ((field_333[this.field_281][this.field_282] & 7) == 1 && (field_332[this.field_281][this.field_282] & 255) == 35) {
			this.field_288 = 0;
			this.field_289 = field_335[this.field_281][this.field_282];
		}
	...
	private void method_157() {
		...
		this.field_285 = 1;
		this.field_286 = method_204(field_324, 1, field_226 % method_313(field_324, 1));
	}
	...
	private void method_158() {
		...
		if ((field_333[this.field_281][this.field_282] & 8) == 0) {
			...
			this.field_288 = field_335[this.field_281][this.field_282] * field_325[var1];
			var3 = this;
			var5 = field_335[this.field_281][this.field_282] * field_325[8 + var1];
		} else {
			label22: {
				switch (var1) {
					case 1:
			...
			this.field_286 = method_204(field_324, this.field_285, field_335[this.field_281][this.field_282]);
	...
	private void method_159() {
		...
		if (this.field_285 != 8 && this.field_285 != 9) {
			...
			this.field_288 = field_324.field_13[var3 + 2];
			var10000 = this;
			var10001 = field_324.field_13[var3 + 3];
		} else {
			this.field_286 = 0;
			int var1 = (field_324.field_12[this.field_285] + 0) * 5;
			this.field_288 = field_324.field_13[var1 + 2];
			var10000 = this;
			var10001 = -field_335[this.field_281][this.field_282];
		}
	...
	private void method_160() {
		...
		switch (this.field_285) {
			case 1:
				var10000 = this;
				var10001 = (field_335[this.field_281][this.field_282] >> 1) % field_320[27].method_4(1);
				break;
			case 3:
				this.field_286 = 0;
				this.field_289 = -field_335[this.field_281][this.field_282];
					...
					if (var6 > 0) {
						...
						while(true) {
							...
							if (method_373(var6, var13, (byte)0, (byte)3) != 0) {
								...
								int var14;
								int var15;
								int var16 = ((var15 = (var14 = this.method_396(var7, var8, var6, var13)) >> 1) == 7 ? field_226 >> 3 : field_226) & 1;
								if (var15 == 15) {
	...
	private void method_165(int var1) {
		int var2;
		if ((var2 = field_332[this.field_281][this.field_282] >> 8) == 255) {
			var2 = 0;
		}
	...
	private void method_166() {
		...
		if ((var3 = field_320[0]) != null) {
			...
			var10000.method_8(var2, 1, 0, 0, 0, 0, 0);
			if (this.field_179) {
			...
			if (this.field_239 != this.field_410 || this.field_170 || this.field_239 <= 1) {
				...
				for(int var9 = 0; var9 < field_330[8]; ++var9) {
					Graphics var12;
					Image[] var10001;
					byte var10002;
					if ((this.field_239 > 1 || var9 != 0 || (field_226 >> 2 & 1) != 0) && (var9 >= this.field_239 || this.field_239 <= 1)) {
						var12 = var2;
						var10001 = var4;
						var10002 = 13;
					} else {
					...
					var12.drawImage(var10001[var10002 + var6], var7 + var5, -29, 0);
					var5 += var8;
				}
	...
	private void method_181(Graphics var1) {
		...
		if (this.field_281 >= 60 && this.field_281 < 65 && this.field_282 >= 2 && this.field_282 < 7) {
			field_320[10].method_8(var1, 4 + (this.field_282 - 2) * 5 + this.field_281 - 60, this.field_271, this.field_272, 0, 0, 0);
		}
	...
	private void method_182() {
		if (this.field_180 != -1) {
			...
			if (this.field_180 == 12) {
				int var2 = this.field_185 - this.field_201 + field_226 * this.field_181 % 48;
				int var3 = field_323[5].field_69 + 24;
				field_320[7].method_7(this.field_314, 0, field_226 % field_320[7].method_4(1), var2, var3, 0, 0, 0);
	...
	private void method_183() {
		if (this.field_174 == 3 && (long)field_226 >= this.field_454 + 80L) {
		...
		if (this.field_180 != 15) {
			...
			if (this.field_180 == 12) {
				int var4 = this.field_184 - this.field_201 + field_226 * this.field_181 % 48;
				int var2 = field_323[5].field_69 + 24;
				field_320[7].method_7(this.field_314, 0, field_226 % field_320[7].method_4(0), var4, var2, 0, 0, 0);
	...
	private void method_184() {
		...
		if (this.field_180 == 7) {
			...
			field_320[7].method_7(var1, 1, field_226 % field_320[7].method_4(1), var3, var4, 0, 0, 0);
	...
	private void method_187() {
		...
		int var5 = this.currenLevelHeight * 24 - this.field_176 - this.field_202;
		int var6;
	...
	private void method_188() {
		for(int var1 = 3; var1 < 13; var1 += 2) {
			int var2;
			int var3 = ((var2 = 10 * (2 * var1 / 5 + 1)) + field_226 / var2) * var1 % 240;
			int var4 = 320 / var2 * field_226 % 320;
	...
	private void method_189() {
		if (this.field_189 && this.field_354 == null && this.field_258 == -1) {
			field_320[15].method_7(this.field_314, 0, field_226 >> 1 & 3, this.field_269, this.field_270 - 24, 0, 0, 0);
		}
	...
	private void method_190() {
		Graphics var1 = this.field_314;
		int var3 = (field_226 << 3) % 160;
		int var2 = (field_226 / 160 & 1) == 0 ? 160 - var3 : 0 + var3;
	...
	private void method_192() {
		int var1 = this.field_281;
		int var2;
		int var3 = (var2 = this.field_282) + 1;
		this.field_273 = 0;
		this.field_274 = 0;
		this.field_277 = false;
		int var4;
		...
		switch (this.field_283) {
			...
			case 8:
				this.field_216 = 16;
				this.field_217 = 0 + (field_226 >> 1 & 1);
				break;
			case 9:
			...
			case 47:
				field_324 = field_320[30];
				this.field_285 = 0;
				this.field_286 = method_204(field_324, 0, field_226 % method_313(field_324, 0));
		}

		if (var7 || field_500 != null && field_500[var1][var3] != 0 && method_344(var1, var3)) {
			int var22;
			int var23 = (var22 = (field_226 >> 1) + var1) % 4;
			if ((var22 / 4 & 1) == 1) {
				var23 = 4 - var23;
			}
		...
		if (this.field_283 == 0) {
			...
			if (this.field_278 >= 0 && this.field_278 < 5) {
				...
				this.field_274 = 13;
				this.field_275 = this.field_281;
				this.field_276 = this.field_282 - 1;
			}
		}
	...
	private void method_193() {
		...
		if (((var6 = (var3 & 28672) >> 12) != 2 && var6 != 4 && var5 != 2 && var5 != 4 || field_334[var1 - 1][var2] < 0 || field_334[var1 + 1][var2] < 0) && (var6 != 1 && var6 != 3 && var5 != 1 && var5 != 3 || field_334[var1][var2 - 1] < 0 || field_334[var1][var2 + 1] < 0)) {
			...
			var10000 = this;
			var10001 = (field_226 >> 1) % field_324.method_4(this.field_285);
		} else {
			this.field_285 = 1;
			var10000 = this;
			var10001 = 0;
	...
	private void method_196() {
		int var1 = field_332[this.field_281][this.field_282] & 255;
		int var2 = field_332[this.field_281][this.field_282] >> 8;
		if (var1 != 14 && var1 != 33 || var2 > 11) {
			...
			var10000.field_289 = -(var10001[var10002].method_4(0) - var2);
		}
	...
	private void method_197() {
		...
		if ((var3 = (field_333[var1][var2] & 3840) >> 8) >= 4) {
			...
			if (var3 == 0) {
				var10000 = this;
				var10001 = 0 + (field_226 >> 1) % 3;
			} else {
				var10000 = this;
				var10001 = 3 + var3 - 1;
			}

			var10000.field_217 = var10001;
	...
	private void method_201() {
		...
		int var2 = field_333[this.field_281][this.field_282];
		byte var3;
		if ((var3 = field_335[this.field_281][this.field_282]) > 24) {
			var3 = 24;
		}
	...
	private void method_202() {
		if (field_334[this.field_281][this.field_282 + 1] != 16) {
			...
			this.field_288 = var2.field_13[var7 + 2];
		}
	}
	...
	private void method_203() {
		...
		int var2 = (field_333[this.field_281][this.field_282] & 2088960) >> 13;
		if (this.field_285 == 10) {
			...
			this.field_288 = field_324.field_13[var8 + 2];
			this.field_289 = field_324.field_13[var8 + 3];
		}
	...
	private void method_207() {
		...
		byte var2 = 3;
		int var3;
		if (((var3 = field_333[this.field_281][this.field_282]) & 7) == 3) {
			var1 = 1;
			var2 = 0;
		}
		...
		if ((var3 & 8) == 0) {
			var4 = this.field_219;
			var10000 = this.field_218;
		} else {
			var4 = this.field_221;
			var10000 = this.field_220;
		}
		...
		if (var1 == 1) {
			var7 = field_320[42];
			var10001 = this.field_314;
			var10002 = field_334[this.field_281][this.field_282 - 1] - 80;
			var10003 = this.field_271;
			var10004 = this.field_272 - 24;
		} else {
			var7 = field_320[42];
			var10001 = this.field_314;
			var10002 = field_334[this.field_281][this.field_282 + 1] - 80;
		...
		var7.method_8(var10001, var10002, var10003, var10004, 0, 0, 0);
	}
	...
	private void method_208() {
		...
		if (field_226 > 30) {
			...
			if ((var4 = (field_226 - 30) * 4) > 29) {
				...
				int var10004;
				if (field_226 < 42) {
					int var5 = 42 - field_226;
					var3 = 0 + var5 * var5 % ((var5 >> 1) + 1);
					var10000 = var1.field_73;
					var10001 = this.field_314;
					var10002 = 10;
					var10003 = 138;
					var10004 = 136 + var3;
				...
				var10000.method_8(var10001, var10002, var10003, var10004, 0, 0, 0);
				var1.field_75 = 0;
			} else {
			...
			var1.field_68 = field_226 * 4 - 1 + 18;
		}
				...
				if (!isKeyPressed(SKEY_RSH)) {
					...
					if (this.field_391 || this.field_392) {
						for(int var2 = 0; var2 <= 2; ++var2) {
							int var3 = this.method_122(var2);
							if (var2 == 2) {
								++var3;
							}

							for(int var4 = 0; var4 <= var3; ++var4) {
								this.method_117(var2, var4, (byte)2);
								this.method_117(var2, var4, (byte)64);
							}

							this.method_118(var2, var3);
						}

						if (this.field_392) {
							for(int var5 = 0; var5 <= 2; ++var5) {
								int var6 = this.method_121(var5);
								if (var5 == 0) {
									--var6;
								}

								for(int var7 = this.method_122(var5); var7 < var6; ++var7) {
									this.method_117(var5, var7, (byte)2);
									this.method_117(var5, var7, (byte)64);
								}

								this.method_118(var5, var6 - 1);
							}
						}
					}
	...
	private void method_230(int var1, int var2) {
		...
		if (!var5) {
			for(int var9 = 0; var9 < 5; ++var9) {
				...
				int var11 = var2 + var4[var9];
				if (var10 >= 0 && var10 < this.currentLevelWidth && var11 >= 0 && var11 < this.currenLevelHeight) {
	...
	private void method_233(int var1, int var2, int var3) {
		...
		if (var1 == 43 && (var4 & 248) == 0) {
			...
			int var5; //FIXME USELESS
			int var6;
			var4 = ((var6 = ((var5 = var4 - 0x8000) & -16646145 | var2 << 17) & -2130706433 | var3 << 24) & 7) != 1 && (var6 & 7) != 3 ? var6 & Integer.MAX_VALUE : var6 | Integer.MIN_VALUE;
		}
	...
	private void method_236() {
		...
		if ((this.field_122 || this.field_461) && field_226 > 140) {
			if (this.field_461) {
				this.addCollectedDiamonds();
			}
		...
		if (this.field_162 != this.field_163) {
			int var10000 = this.field_162;

			while(true) {
				int var10 = var10000;
				if (var10000 == this.field_163) {
					break;
				}

				field_160[var10]++;
				int var14 = field_161[var10] < 0 ? method_313(field_320[2], 0) : field_320[9].method_4(field_161[var10]);
				if (field_160[var10] >= var14) {
					this.field_162++;
					this.field_162 &= 7;
				}
		...
		if (this.field_311 != 0 && (field_226 >> 1 & 1) == 0) {
			this.field_310 += this.field_311;
			if (this.field_310 != 0 && this.field_310 != 9) {
				if (this.field_310 == 5) {
					int var12 = this.currenLevelHeight - 1;
					...
					for(int var22 = 1; var22 < var12; ++var22) {
						for(int var26 = 1; var26 < var16; ++var26) {
							boolean var8;
							label448: {
								int var6 = field_332[var26][var22] & 255;
								byte var7 = field_334[var26][var22];
								var8 = false;
								if (var6 == 15) {
									this.method_235(var26, var22);
									field_334[var26][var22] = 34;
								} else if (var6 == 16) {
									this.method_235(var26, var22);
									field_334[var26][var22] = 35;
								} else {
									int[] var30;
									int var10001;
									byte var10002;
									if (var7 == 34) {
										var30 = field_332[var26];
										var10001 = var22;
										var10002 = 15;
									} else {
										if (var7 != 35) {
									...
									field_334[var26][var22] = -1;
									this.method_397(var26, var22);
								}
				...
				for(int var11 = 1; var11 < this.currenLevelHeight - 1; ++var11) {
					for(int var15 = 1; var15 < this.currentLevelWidth - 1; ++var15) {
						int var4 = field_332[var15][var11] & 255;
						byte var5 = field_334[var15][var11];
						if (var4 == 15 || var4 == 16 || var5 == 34 || var5 == 35) {
							this.method_148(var15, var11);
						}
					}
				}
			}
		...
		label423: {
			...
			if (this.field_234 > 0) {
				...
				if (this.field_238 && this.field_232 <= 0) {
					if (this.field_551) {
						var32 = this;
						var36 = this.field_307;
					} else {
						var32 = this;
						var36 = this.field_308;
					}
	...
	private void method_239() {
		...
		for(int var2 = 0; var2 < field_192.length; var2 += 3) {
			byte var3;
			if ((var3 = field_192[var2 + 2]) > 0) {
				byte var4 = field_192[var2 + 1];
				byte var5 = field_192[var2 + 0];
				var5 = field_192[var2 + 0] = this.method_237(var5, -1, 0, var3);
				var4 = field_192[var2 + 1] = this.method_237(var4, 1, var1, var3);

				for(int var6 = var5; var6 <= var4; ++var6) {
					this.method_240(var6, var3);
				}
			}
		}
	...
	private void method_249(int var1) {
		switch (var1) {
			...
			case 8:
				...
				if (var2 < var3) {
					byte[] var10000 = field_330;
					var10000[2] = (byte)(var10000[2] & -225);
					var10000 = field_330;
					var10000[2] = (byte)(var10000[2] | var3 << 5 & 224);
					this.method_110();
					this.field_144 = var3;
				}
			case 9:
	...
	private void method_250() {
		switch (this.field_223) {
			case 0:
				if (field_226 > 40 || this.field_225) {
					++this.field_223;
					this.method_65();
					return;
				}
				break;
			case 1:
				if (field_226 > this.collectedDiamonds << 1 && field_226 > 40 || this.field_225) {
					++this.field_223;
					this.method_65();
					return;
				}
			...
			case 2:
				...
				break;
			case 3:
				if (field_226 > 10 || this.field_225) {
					++this.field_223;
					this.method_65();
					return;
				}
	...
	private void method_260() {
					...
					switch (var2.field_74) {
						...
						case 47:
							...
							if ((field_226 & 1) == 0) {
								...
								this.method_254(var7, var8, field_226 * 3 % 5);
							}
		...
		if (var5) {
			var16 = this;
			var10001 = this.field_194 - 1;
		} else {
			var16 = this;
			var10001 = 70;
		}

		var16.field_194 = var10001;
		if (var3 != -1) {
	...
	private void method_269() {
		...
		if (this.field_180 == 12) {
			...
			int var6 = this.field_182 > 0 && field_226 % this.field_182 == 0 ? 2 : 1;
			if (this.field_180 == 6 || this.field_180 == 7) {
				var6 = (field_226 & 11) == 0 ? 2 : var6;
			}
			...
			if (!this.field_450 && (this.field_180 == 0 || this.field_180 == 1)) {
				...
				if (this.field_180 == 0) {
					...
					var9 = this;
					var10001 = this.field_451 + 1;
				} else {
					var9 = this;
					var10001 = 36;
				}

				var9.field_451 = var10001;
				if (var4 < 504 && (var3 == var5 + this.field_451 || field_226 % 76 == 0)) {
					this.field_450 = true;
				}
			}
	...
	private void method_270() {
		...
		if (this.field_230 == var1 || this.field_230 == var1 + 1) {
			...
			var5 = (var2.field_73.field_13[var5 + 3] << 0) * 1 / 1;
			var3 -= var5;
			var4 -= var5;
			int var6;
	...
	private int method_275() {
		...
		return this.currenLevelHeight * var2 / (this.currenLevelHeight * 24);
	}
	...
	private void method_278() {
		...
		switch (this.field_180) {
			...
			case 5:
				...
				var9 = (var1.field_73.field_13[var9 + 3] << 0) * 1 / 1;
			...
			case 9:
				...
				var11 = (var1.field_73.field_13[var11 + 3] << 0) * 1 / 1;
		...
		if (this.field_180 == 12) {
			...
			while(var12-- > 0) {
				switch (this.field_180) {
					...
					case 2:
						if (var1.method_46()) {
							if ((long)field_226 > this.field_453) {
								var17 = 13;
								this.field_180 = 13;
							} else {
								var17 = 4;
		...
		if (field_323[2].field_74 == 2) {
			...
			if (field_323[1].field_74 == 0) {
				if ((this.field_354 == null || this.field_176 < 46) && this.field_176 < 1704) {
					++this.field_176;
					int var1 = this.currenLevelHeight * 24 - (this.field_202 + 320 - 80);
	...
	public final void method_285() {
		...
		var8.field_202 = var10.field_204 = var10002;
	}
	...
	private boolean method_288(int var1, int var2, boolean var3) {
		...
		boolean var15 = false;
		boolean var16 = false;
		if (var13 >= 0 && var13 < this.currentLevelWidth && var14 >= 0 && var14 < this.currenLevelHeight) {
			...
			label328: {
				switch ((byte)(field_332[var13][var14] & 255)) {
					...
					case 19:
						...
						this.field_474 = false;
						if (field_500 == null) {
							field_500 = new int[this.currentLevelWidth][this.currenLevelHeight];
						}
					...
					case -1:
						label365: {
						  boolean b6; //NOTE: CHANGED BASED ON PROCYON OUTPUT
							if (var13 != 0 && var14 != 0 && var13 != this.currentLevelWidth - 1 && var14 != this.currenLevelHeight - 1) {
	...
	private void method_293() {
		if (this.field_155) {
			for(int var1 = 0; var1 < this.currentLevelWidth; ++var1) {
				for(int var2 = 0; var2 < this.currenLevelHeight; ++var2) {
	...
	private void method_296() {
		...
		for(int var8 = 0; var8 < this.currentLevelWidth; ++var8) {
			for(int var9 = 0; var9 < this.currenLevelHeight; ++var9) {
		...
		for(int var27 = 0; var27 < this.currenLevelHeight; ++var27) {
	...
	private void method_297(int var1, int var2, int var3, int var4, int var5) {
		if (var1 + var3 > 0 && var1 + var3 < this.currentLevelWidth && var2 + var4 > 0 && var2 + var4 < this.currenLevelHeight) {
			int var9;
	...
	private boolean method_300() {
		...
		label39: {
			if (this.field_202 < 0) {
				this.field_202 = 0;
			} else if (this.field_202 > this.currenLevelHeight * 24 - 320 + 80) {
				this.field_202 = this.currenLevelHeight * 24 - 320 + 80;
	...
	private void method_302(int var1) {
		...
		int var3 = this.currenLevelHeight - 1;
	...
	private void method_304() {
		...
		if (var4 > this.currenLevelHeight - 2) {
	...
	private static int method_313(ASprite var0, int var1) {
		...
		for(int var4 = 0; var4 < var3; ++var4) {
			var2 += var0.field_13[(var0.field_12[var1] + var4) * 5 + 1] & 255;
		}
	...
	private void method_329() {
		int var1;
		if ((var1 = field_333[this.field_279][this.field_280]) > 0) {
			int var2 = this.field_279;
			int var3 = this.field_280;
			if (var1 == 4) {
				for(int var4 = 1; var4 < 5; ++var4) {
					byte var5 = field_325[var4];
					byte var6 = field_325[var4 + 8];
					if (field_334[var2 + var5][var3 + var6] == 30) {
						int var10002 = field_333[var2 + var5][var3 + var6]++;
	...
	private void method_342(int var1) {
		...
		if (field_335[var2][var3] <= 0) {
			...
			} else if ((field_226 >> 1 & 1) == 0 && field_320[var1 == 14 ? 8 : 22] != null && var4 < field_320[var1 == 14 ? 8 : 22].method_4(0) - 1) {
	...
	private void method_346() {
		...
		for(int var1 = 0; var1 < this.currentLevelWidth; ++var1) {
			System.arraycopy(field_333[var1], 0, field_348[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_335[var1], 0, field_350[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_334[var1], 0, field_351[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_332[var1], 0, field_349[var1], 0, this.currenLevelHeight);
		}
	...
	private void method_347() {
		...
		for(int var1 = 0; var1 < this.currentLevelWidth; ++var1) {
			System.arraycopy(field_348[var1], 0, field_333[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_350[var1], 0, field_335[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_351[var1], 0, field_334[var1], 0, this.currenLevelHeight);
			System.arraycopy(field_349[var1], 0, field_332[var1], 0, this.currenLevelHeight);
		}

		int var7 = this.currenLevelHeight - 1;
		...
		if (field_192 != null) {
			for(int var8 = 0; var8 < this.currenLevelHeight; ++var8) {
	...
	private static int method_366(InputStream var0) throws IOException {
		return var0.read() & 255 | (var0.read() & 255) << 8;
	}
	...
	private void method_368() {
		if (this.field_155) {
			if (field_503 == null) {
				field_503 = new int[this.currentLevelWidth][this.currenLevelHeight];
			}

			for(int var1 = 0; var1 < this.currentLevelWidth; ++var1) {
				System.arraycopy(field_500[var1], 0, field_503[var1], 0, this.currenLevelHeight);
			}
	...
	private void method_369() {
		...
		for(int var1 = 0; var1 < this.currentLevelWidth; ++var1) {
			System.arraycopy(field_503[var1], 0, field_500[var1], 0, this.currenLevelHeight);
		}
	...
	private static void method_405(Graphics var0, ASprite var1, String var2, int var3, int var4, int var5, int var6, boolean var7) {
		...
		int var11;
		label31: {
			var2 = method_441(var2, 230);
			var8 = method_361(var1, var2, var7 ? -1 : 0);
			var9 = var1.method_6(var2);
			var10 = var3;
			var11 = var4;
			int var10000;
			int var10001;
		...
		var0.setColor(798521);
		var0.fillRoundRect(var10 - 5, var11 - 5, var8 + 10, var9 + 10, 10, 10);
		var0.setColor(13540096);
		var0.drawRoundRect(var10 - 5, var11 - 5, var8 + 10, var9 + 10, 10, 10);
		var1.method_14(var0, var2, var3, var4, var5);
	}
		...
		try {
			switch (var1) {
				...
				case 6:
					...
					var10000[var10001] = loadGfxFile(var10002, var10003);
					return;
				case 7:
					if (field_320[54] == null) {
						field_320[54] = loadGfxFile("/mmv.f", 1);
	...
	private void method_434() {
		switch (this.field_223) {
			...
			case 1:
				...
				for(int var8 = 0; var8 < GloftDIRU.field_574.length; ++var4) {
					field_565[var4] = GloftDIRU.field_574[var8];
					++var8;
				}
	...
	private void method_435() {
		if (this.field_223 == 2) {
			Graphics var1;
			(var1 = this.field_314).setColor(0, 0, 0);
			var1.fillRect(0, 0, 240, 320);
			int var2 = 0;
			int var3 = -17;
		...
		for(int var10 = 0; var10 <= var9.length(); ++var10) {
			...
			if (var4 > var1 && var6 != var8) {
				...
				if (var11 == 10) {
					...
					var10000 += var16 + var2.spriteDefs[1];
				}
	...
	// $FF: renamed from: cL () void
	private static void method_442() {
		...
		field_320[41].initSprites(2, 0, -1, -1);
	...
	static {
		...
		field_501 = new long[15];
		field_502 = new long[15];
		field_561 = new short[][]{{0, 0, 1, 1, 6, 3, 2, 2, 3, 4, 4, 5, 5, 6}, {0, 25, 1, 26, 2, 2, 6, 4, 3, 49, 4, 27, 5, 6}, {0, 28, 1, 29, 2, 30, 3, 31}, {0, 32, 1, 33}, {0, 45, 1, 46}, {0, 33, 1, 50}, {0, 25, 4, 27}, {0, 101, 1, 100}};
