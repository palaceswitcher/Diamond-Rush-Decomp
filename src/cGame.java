...
public final class cGame extends GameCanvas implements Runnable {
		...
		if (field_367) {
			...
			if (this.field_260 > frameCounter && this.field_174 != 2) {
				if (!this.field_461 && !this.field_122) {
					var4 = (var3 = this.field_260 - frameCounter) < 20 ? (var3 - 10) * 240 / 20 : (var3 >= 50 ? (60 - var3) * 240 / 15 : 120);
					var5 = 240 - var4;
		...
		if ((var3 = field_320[0]) != null) {
			...
			if (this.field_239 != this.field_410 || this.field_170 || this.field_239 <= 1) {
				...
				for(int var9 = 0; var9 < field_330[8]; ++var9) {
					...
					Image[] var10001;
					byte var10002;
					if ((this.field_239 > 1 || var9 != 0 || (frameCounter >> 2 & 1) != 0) && (var9 >= this.field_239 || this.field_239 <= 1)) {
						var12 = var2;
						var10001 = var4;
						var10002 = 13;
					} else {
	...
	private void method_168() {
		...
		ASprite var2;
		(var2 = field_320[5]).method_7(this.field_314, var1, (frameCounter >> 1) % var2.method_4(var1), this.field_271, this.field_272, 0, 0, 0);
	}
	...
	private void method_193() {
		...
		if (((var6 = (var3 & 28672) >> 12) != 2 && var6 != 4 && var5 != 2 && var5 != 4 || field_334[var1 - 1][var2] < 0 || field_334[var1 + 1][var2] < 0) && (var6 != 1 && var6 != 3 && var5 != 1 && var5 != 3 || field_334[var1][var2 - 1] < 0 || field_334[var1][var2 + 1] < 0)) {
			...
			var10000 = this;
			var10001 = (frameCounter >> 1) % field_324.method_4(this.field_285);
		} else {
			this.field_285 = 1;
			var10000 = this;
			var10001 = 0;
	...
	private void method_199() {
		...
		if ((var1 & 512) != 0) {
			...
			var10001 = (byte)(1 + (frameCounter >> 2) % 6);
		} else if ((var1 & 256) != 0) {
			var10000 = this;
			var10001 = 1;
		} else {
