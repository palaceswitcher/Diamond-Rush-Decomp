...
public final class cGame extends GameCanvas implements Runnable {
	...
	public int crtSelectSealItem;
	// $FF: renamed from: f int
	public int crtSealArrowOffsetX;
	// $FF: renamed from: g int
	public int crtSealArrowOffsetY;
	...
	public String crtSealItemName;
	// $FF: renamed from: j int
	public int sealArrowMoveDirection;
	// $FF: renamed from: d boolean
	public boolean isCrtSelectSealItemNeedUpdate;
	// $FF: renamed from: e boolean
	public boolean field_110;
	// $FF: renamed from: a byte
	public byte field_111;
	// $FF: renamed from: k int
	public int sealArrowOffsetX;
	// $FF: renamed from: l int
	public int sealArrowOffsetY;
	...
	public boolean hasLockedGoldenGateInLevel;
	// $FF: renamed from: ah boolean
	public boolean hasLockedSilverGateInLevel;
	...
	public cGame(GloftDIRU var1) {
		...
		this.field_99 = "";
		this.field_100 = true;
		this.crtSelectSealItem = 0;
		this.crtSealArrowOffsetX = 0;
		this.crtSealArrowOffsetY = 0;
		this.field_104 = this.crtSealArrowOffsetX;
		this.field_105 = this.crtSealArrowOffsetY;
		this.field_106 = "";
		this.crtSealItemName = "";
		this.sealArrowMoveDirection = -1;
		this.isCrtSelectSealItemNeedUpdate = false;
		this.field_110 = true;
		this.field_111 = 0;
		this.sealArrowOffsetX = 0;
		this.sealArrowOffsetY = 0;
		this.field_114 = 0;
		this.field_115 = 0;
		this.field_116 = 0;
		this.field_117 = 0;
		...
		this.debugScreenMode = 0;
		this.debugScreenSels = new int[]{0, 0, 0, 0, 0};
	...
	private void method_62(byte var1) {
		...
		if (this.field_239 <= 0) {
			this.field_239 = 0;
		} else if (this.field_239 > recordData[8]) {
			this.field_239 = recordData[8];
		}
	...
	private void method_67() throws Exception {
		...
		default:
			break;
		case 5:
			if (this.field_329 && this.assetsLoaded <= 5) {
				this.method_113(this.assetsLoaded++);
		...
		case 7:
			...
			break;
		case 8:
			this.method_76(this.assetsLoaded++);
			this.method_65();
			return;
		case 9:
			try {
				...
				this.method_109();
				int var1 = this.assetsTotal == 8 ? this.assetsLoaded : this.assetsLoaded - 24;
		...
		case 20:
			...
			break;
		case 21:
			this.method_425(this.assetsLoaded++);
			this.method_65();
			return;
		case 22:
			this.method_434();
		...
		case 28:
			try {
				this.method_71(this.assetsLoaded);
				this.assetsLoaded++;
				if (this.assetsLoaded == 11) {
					gameState = 27;
				}
			} catch (Exception var2) {
			}
		...
		case 31:
			return;
		case 35:
			this.method_249(this.assetsLoaded++);
			this.method_65();
			if (this.assetsLoaded == 12) {
				gameState = 17;
				this.field_223 = 0;
	...
	private void method_70() {
		this.field_372 = false;
		freeSpriteCache(field_320[17], true);
		field_320[17] = null;
		...
		IGA.field_58 = null;
		freeSpriteCache(field_320[10], true);
		field_320[10] = null;
		freeSpriteCache(field_320[46], true);
		field_320[46] = null;
		freeSpriteCache(field_320[55], true);
		field_320[55] = null;
		field_318[8] = null;
		freeSpriteCache(field_320[59], true);
		field_318[3] = null;
		freeSpriteCache(field_320[17], true);
		field_320[17] = null;
		System.gc();
	...
	private void method_71(int var1) {
		...
		case 10:
			...
			if ((var2 & 1) != 0) {
				field_119[1] = true;
			} else if (getShortFromBytes(recordData, 6) < Define.worldPrices[1]) {
				field_119[1] = false;
			} else {
				recordData[1] |= 1;
				this.method_110();
				this.field_118 = 1;
				this.crtSelectSealItem = 1;
			}

			if ((var2 & 2) != 0) {
				field_119[2] = true;
			} else if (getShortFromBytes(recordData, 6) < Define.worldPrices[2]) {
				field_119[2] = false;
			} else {
				recordData[1] |= 2;
				this.method_110();
				this.field_118 = 2;
				this.crtSelectSealItem = 2;
			}

			this.crtSealArrowOffsetX = Define.sealArrowPosOffset[this.crtSelectSealItem << 1];
			this.crtSealArrowOffsetY = Define.sealArrowPosOffset[(this.crtSelectSealItem << 1) + 1];
			this.field_104 = this.crtSealArrowOffsetX;
			this.field_105 = this.crtSealArrowOffsetY;
			this.updateCrtSealItemName();
			this.field_110 = true;
			this.field_557 = true;
		}
	...
	private void updateCrtSealItemName() {
		...
		case 0:
			this.crtSealItemName = menuText[28];
			break;
		case 1:
			this.crtSealItemName = menuText[29];
			break;
		case 2:
			this.crtSealItemName = menuText[30];
			break;
		case 3:
			this.crtSealItemName = menuText[31];
			break;
		}
	}
	...
	private static boolean method_73(int var0) {
		if (var0 != 0 && var0 != 3) {
			return getShortFromBytes(recordData, 6) >= Define.worldPrices[var0];
		} else {
			return true;
		}
	}
	...
	private void method_75() {
		...
		if (this.isCrtSelectSealItemNeedUpdate) {
			keysPressed = 0;
			int var1 = this.sealArrowOffsetX - this.crtSealArrowOffsetX;
			...
			label33:
				switch (this.sealArrowMoveDirection) {
				case -1:
					break;
				case 4:
					switch (this.crtSelectSealItem) {
				...
				default:
					...
					if (var3 != -1) {
						...
						this.sealArrowOffsetY = Define.sealArrowPosOffset[this.crtSelectSealItem * 2 + 1];
					}
				}
	...
	private void method_78() {
		try {
			...
			case 9:
				this.method_296();
				return;
			case 10: // Get current world block sprite
				String var2 = "/" + this.currentWorld + ".f";
				this.field_306 = this.getClass().getResourceAsStream(var2);
				// Get how many sprites in packed data file
				this.field_304 = this.field_306.read();
				// Load data length and data offset in packed data file
			...
			default:
				int var6 = var1 - 10 - 1;
				if (var6 < 4) {
					// Load sprite in 0.f, 1.f or 2.f
					this.loadCrtWorldBlockSprite(var6);
					this.field_267 = 0;
				} else {
					var6 -= 4;
					if (var6 >= 0 && var6 < 43) {
						// Load needed sprite in gen*.f
						this.loadGenSprite(var6);
					} else {
						var6 -= 43;
						if (var6 >= 0 && var6 < 8) {
							this.loadCmSprite(var6);
							// Already load all needed sprites in cm.f
							// close file stream
							if (var6 == 7) {
	...
	private void method_86() {
		this.assetsTotal = this.field_329 ? 97 : 92;
		this.assetsLoaded = 0;
		this.field_375 = true;
	...
	private void method_92() {
		...
		field_355 = null;
		freeSpriteCache(field_320[42], true);
		freeSpriteCache(field_320[43], true);
		System.gc();
	}
		...
		if (var0 != null) {
			if (DemoInterpreter.field_41 != null) {
				for (int var1 = 0; var1 < DemoInterpreter.field_41.length; ++var1) {
					freeSpriteCache(DemoInterpreter.field_41[var1], true);
	...
	// Free cache data in sprite
	// @param spr Sprite need to free
	// @param freeCacheImage Free module image cache
	private static void freeSpriteCache(ASprite spr, boolean freeCacheImage) {
		if (spr != null) {
			spr.freeCache(freeCacheImage);
		}
	}
	...
	private void method_95() {
		...
		freeSpriteCache(field_499, true);
		System.gc();
		if (field_320 != null) {
			for (int var5 = 0; var5 < 61; ++var5) {
				if (var5 != 41 && var5 != 0 && var5 != 9 && var5 != 18) {
					freeSpriteCache(field_320[var5], true);
					field_320[var5] = null;
				}
			}
		}
		...
		if (field_323 != null) {
			for (int var6 = 0; var6 < 6; ++var6) {
				if (field_323[var6] != null) {
					freeSpriteCache(field_323[var6]._sprite, true);
	...
	private void loadCrtWorldBlockSprite(int sprIndex) throws Exception {
		...
		// We already decode all the module data, so release it
	...
	private void loadCmSprite(int spriteNum) {
		try {
			...
			case 3:
				...
				break;
			case 4:
				field_318[5] = var4._modules_image[0];
				break;
			case 5:
				field_318[18] = var4._modules_image[0];
				break;
			case 6:
				field_320[43] = var4;
				field_318[20] = null;
	...
	private void loadGenSprite(int sprIndex) {
		try {
			...
			var5.Load(var4, 0);
			if ((sprIndex != 28 || this.hasLockedGoldenGateInLevel) && (sprIndex != 24 || this.field_460)) {
	...
	private static boolean method_105() {
		if (recordData == null) {
			...
			return recordData[13] != 0;
		}
	}

	// $FF: renamed from: b (boolean) void
	private void method_106(boolean var1) {
		recordData[13] = (byte)(var1 ? 1 : 0);
		this.method_110();
	}
	...
	private void method_109() {
		try {
			RecordStore var1;
			recordData = (var1 = RecordStore.openRecordStore("DiamondRush", true)).getRecord(1);
			this.field_382 = recordData.length;
	...
	private void method_110() {
		...
		try {
			...
			if ((var1 = RecordStore.openRecordStore("DiamondRush", true)).getNumRecords() == 0) {
				var1.addRecord(recordData, 0, this.field_382);
			} else {
				var1.setRecord(1, recordData, 0, this.field_382);
			}
	...
	private void method_113(int var1) {
		try {
			...
			case 4:
				...
				recordData[14 + var4 * 2] = (byte)(this.field_382 & 255);
				recordData[14 + var4 * 2 + 1] = (byte)(this.field_382 >> 8);
				int var6 = this.field_306.read();
				recordData[this.field_382++] = (byte)var6;
				recordData[this.field_382++] = 0;
				this.method_409();
				this.method_426(var2);
				recordData[this.field_382++] = (byte)this.field_515;
				this.method_407();
				this.field_382 += var6 << 1;

				for (int i = 0; i < var6; i++) {
					int var8 = this.field_382;
					recordData[var5 + 3 + i * 2] = (byte)(var8 & 255);
					recordData[var5 + 3 + i * 2 + 1] = (byte)(var8 >> 8);
					byte var9 = 0;
					byte var10 = 0;
					...
					recordData[0] += var10;
					recordData[this.field_382++] = 0;
					recordData[this.field_382++] = var10;
					recordData[this.field_382++] = 0;
					...
					for (int var20 = 0; var20 < var12; ++var20) {
						for (int var16 = 0; var16 < var11; ++var16) {
							if (var13[var16 + var20 * var11] == 14 || var13[var16 + var20 * var11] == 33) {
								recordData[this.field_382++] = (byte)var16;
								recordData[this.field_382++] = (byte)var20;
								++var9;
							}
						}
					}
	...
	private int method_119(int var1) {
		...
		return var2 >= 0 && var2 <= recordData.length ? recordData[method_120(var1) + 1] : 0;
	}
	...
	private int method_121(int var1) {
		try {
			return recordData[method_120(var1) + 0];
		} catch (Exception var3) {
			return 0;
		}
	}
	...
	private int method_122(int var1) {
		return recordData[method_120(var1) + 2];
	}
	...
	private void method_125(int var1, int var2, int var3) {
		recordData[this.method_123(var1, var2) + 0] = (byte)var3;
	}

	// $FF: renamed from: c (int, int) int
	private int method_126(int var1, int var2) {
		return recordData[this.method_123(var1, var2) + 1];
	}

	// $FF: renamed from: a (int, int, int, int) void
	private void method_127(int var1, int var2, int var3, int var4) {
		int var5 = this.method_123(var1, var2);
		byte var6 = recordData[var5 + 4];

		for (int var7 = 0; var7 < var6; ++var7) {
			if (recordData[var5 + 5 + 2 * var7 + 0] == var3 && recordData[var5 + 5 + 2 * var7 + 1] == var4) {
				recordData[var5 + 5 + 2 * var7 + 0] = 0;
				recordData[var5 + 5 + 2 * var7 + 1] = 0;
				++recordData[var5 + 3];
				return;
			}
		}
	...
	private void method_132(Graphics var1) {
		try {
			...
			case 1:
				this.method_153();
				break;
			case 2: // Pause menu (while in level)
				this.method_175();
				break;
			case 4: // Title screen (after button pressed)
				this.method_141();
				break;
			case 5:
				if (!this.field_388) {
				...
				break;
			case 6:
				this.method_208(); // Gameloft logo animation
				break;
			case 7:
				this.method_175(); // Startup sound toggle
				break;
			case 8: // Loading title screen
			case 9:
			case 21:
			case 35:
				this.renderProgressBar();
			...
			case 18:
				...
				this.field_555 = menuText[110] + " " + getShortFromBytes(recordData, 4) + " " + menuText[109];
			case 25:
				this.method_431();
				break;
			case 20:
			...
			case 29:
				this.method_136();
				break;
			case 30: // Title screen (before button pressed)
				this.drawSplash(this.field_314, true);
				if (frameCounter % 20 >= 10) {
					field_320[41].drawString(this.field_314, menuText[82], 120, 250, 17); // Flash text every half second
				}
				break;
			case 31:
				if (this.field_387) {
					...
					field_320[41].DrawPage(this.field_314, getWrapText(menuText[this.recordEmpty ? 69 : 68], 220), 120, 160, Graphics.HCENTER|Graphics.HCENTER);
					this.drawOKButton();
					this.drawBackButton();
				}
				break;
		...
		// FIXME: DEBUG ADDITION
		if (field_320[41] != null) {
			field_320[41].drawString(this.field_314, Integer.toString(gameState), 0, 0, Graphics.TOP|Graphics.LEFT);
			//field_320[41].drawString(this.field_314, Long.toString(field_370) + "   ", 0, 16, Graphics.TOP|Graphics.LEFT); 
		}
	}
	...
	private void method_134(Graphics var1, boolean var2, int var3, int var4) {
		...
		field_320[10].drawFrame(var1, 0, this.field_116 + var3, this.field_117 + var4, 0, 0, 0);
		if (var2) {
			for (int var13 = 0; var13 < 320; var13 += 24) {
				for (int var14 = 0; var14 < 240; var14 += 24) {
					field_320[17].drawFrame(var1, 16, var14, var13, 0, 0, 0);
				}
			}
		}
	...
	private void method_136() {
		if (this.field_557) {
			...
			field_320[17].drawFrame(this.field_314, 11, 120 + Define.sealItemPosOffset[6] + this.field_147, 136 + Define.sealItemPosOffset[7] + this.field_148, 0, 0, 0);
			int var1 = 0;

			for (int var2 = 0; var2 < 3; ++var2) {
				var1 = 52 + var2;
				field_320[var1].drawFrame(this.field_314, 0, Define.sealItemPosOffset[var2 << 1] + 120 - this.field_126 + this.field_147, Define.sealItemPosOffset[(var2 << 1) + 1] + 136 - this.field_127 + this.field_148, 0, 0, 0);
			}
		}
		...
		case 1:
			if (!this.field_557) {
				...
				for (int var7 = 0; var7 < 3; ++var7) {
					int var5 = 52 + var7;
					field_320[var5].drawFrame(this.field_314, 0, Define.sealItemPosOffset[var7 << 1] + 120 - this.field_126, Define.sealItemPosOffset[(var7 << 1) + 1] + 136 - this.field_127, 0, 0, 0);
				}
			}
			break;
		case 2:
		...
		case 10:
			...
			field_320[41]._nLineSpacing = 3;
			String var6 = getWrapText(menuText[40] + "\n" + menuText[97], 220);
	...
	private void method_137() {
		if (!this.field_557 && !this.field_110) {
			...
			field_320[10].drawFrame(this.field_314, 0, this.field_116, this.field_117, 0, 0, 0);
		} else {
			this.field_314.setClip(0, 0, 240, 320);
			this.method_135(this.field_314, false);
			field_320[17].drawFrame(this.field_314, 11, 120 + Define.sealItemPosOffset[6], 136 + Define.sealItemPosOffset[7], 0, 0, 0);
			this.drawBackButton();
			this.drawOKButton();
		...
		if (this.field_118 != 0) {
			...
			for (int var1 = 0; var1 < this.field_118; ++var1) {
				if (method_73(var1)) {
					field_320[10].drawFrame(this.field_314, var1 + 1, this.field_116, this.field_117, 0, 0, 0);
				}
			}

			this.field_314.setClip(0, 0, 240, 320);
			if (this.field_130 < this.field_129) {
				field_320[9].drawAnimFrame(this.field_314, 5, this.field_130, Define.sealItemPosOffset[this.field_118 << 1] + 120 - 12, Define.sealItemPosOffset[(this.field_118 << 1) + 1] + 124, 0, 0, 0);
				this.field_130++;
			} else {
				if (this.field_115 % this.field_114 >= this.field_114 >> 1) {
					field_320[10].drawFrame(this.field_314, this.field_118 + 1, this.field_116, this.field_117, 0, 0, 0);
					++this.field_120;
				}
			...
			for (int var8 = 0; var8 < 3; ++var8) {
				if (field_119[var8]) {
					field_320[10].drawFrame(this.field_314, var8 + 1, this.field_116, this.field_117, 0, 0, 0);
				}
			}
		}
		...
		for (int var2 = 0; var2 < 3; ++var2) {
			if (field_121[var2]) {
				...
				if (this.field_123 != var2) {
					field_320[var9].drawFrame(this.field_314, 0, Define.sealItemPosOffset[var2 << 1] + 120 - this.field_126, Define.sealItemPosOffset[(var2 << 1) + 1] + 136 - this.field_127, 0, 0, 0);
				}
			}
		}
		...
		if (this.field_123 != -1) {
			...
			this.field_314.setClip(this.crtSealArrowOffsetX + 120, 136 + this.crtSealArrowOffsetY, 14, 22);
			field_320[55].drawAnimFrame(this.field_314, 0, this.field_115, 120 + this.crtSealArrowOffsetX, 136 + this.crtSealArrowOffsetY, 0, 0, 0);
			this.field_115++;
			if (this.field_110) {
				int oldLineSpacing = field_320[41]._nLineSpacing;
				field_320[41]._nLineSpacing = 1;
				String var3 = getWrapText(this.field_106 + "\n" + this.crtSealItemName, 220);
				...
				field_320[41]._nLineSpacing = oldLineSpacing;
				this.field_110 = false;
			}
	...
	private boolean method_138(int var1) {
		...
		label49: {
			var2 = 52 + var1;
			var3 = Define.sealItemPosOffset[var1 << 1] + 120;
			int var5 = (var4 = Define.sealItemPosOffset[(var1 << 1) + 1] + 136) - this.field_125;
		...
		field_320[var2].drawFrame(this.field_314, 0, this.field_124 - this.field_126, this.field_125 - this.field_127, 0, 0, 0);
		if (this.field_124 == var3 && this.field_125 == var4) {
			...
			if (this.field_128 < 20) {
				...
				field_320[9].drawAnimFrame(this.field_314, 5, this.field_130, Define.sealItemPosOffset[var1 << 1] + 120 - 12, Define.sealItemPosOffset[(var1 << 1) + 1] + 124, 0, 0, 0);
				++this.field_130;
				return false;
			} else {
				this.field_130 = 0;
	...
	private void drawDebugScreen() {
		...
		this.field_314.fillRect(0, 0, 240, 320);
		String var1;
		switch (this.debugScreenMode) {
		case 0:
			var1 = "Mix";
			var2.DrawPage(this.field_314, menuText[this.debugScreenSels[0]], 10, 5, 20);
			break;
		case 1:
			var1 = "Tips";
			method_403(this.debugScreenSels[1]);
			this.drawGameTip();
			break;
		default:
			var1 = "";
		...
		var2.drawString(this.field_314, "" + this.debugScreenSels[this.debugScreenMode], 120, 308, 20);
	...
	// Draw splash image in main menu
	private void drawSplash(Graphics g, boolean showCopyright) {
		g.drawImage(field_316, 0, 0, Graphics.TOP|Graphics.LEFT);
		g.drawImage(field_315, 0, 0, Graphics.TOP|Graphics.LEFT);
		if (showCopyright) {
			g.drawImage(field_317, 120, 319, Graphics.BOTTOM|Graphics.HCENTER);
		}
	...
	private void method_143() {
		...
		if (this.field_174 == 2) {
			...
			String var2 = menuText[111] + " " + (getShortFromBytes(recordData, 4) < 500 ? getShortFromBytes(recordData, 4) : 500) + " " + menuText[109];
				...
				if (this.processedTileX >= 0 && this.processedTileX < this.crtLevelWidth && this.processedTileY >= 0 && this.processedTileY < this.crtLevelHeight) {
					...
					if (this.field_214 != -1) {
						if (field_318[this.field_214] == null) {
							field_320[method_149(this.field_214)].drawFrame(var14, this.field_215, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_290, 0, 0);
						} else {
					...
					if (this.field_283 != -1 && !var5) {
						...
						if (var13 >= 0) {
							...
							case 1:
								...
								break;
							case 10:
								field_320[16].drawFrame(var14, 0, this.field_271, this.field_272, 0, 0, 0);
								break;
							case 34:
								if (this.field_310 == 9) {
									this.field_216 = 14;
						...
						if (this.field_216 != -1) {
							if (field_318[this.field_216] == null) {
								field_320[method_149(this.field_216)].drawFrame(var14, this.field_217, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_290, 0, 0);
							} else {
				...
				if (this.processedTileX >= 0 && this.processedTileX < this.crtLevelWidth && this.processedTileY >= 0 && this.processedTileY < this.crtLevelHeight) {
					...
					if (this.field_284 > -1 && this.field_284 < 38) {
						...
						case 16:
							...
							break;
						case 34:
							field_320[27].drawAnimFrame(var1, 2, 0, this.field_271, this.field_272, 0, 0, 0);
							break;
						case 35:
							this.method_157();
							break;
						...
						if (this.field_214 != -1) {
							if (field_318[this.field_214] == null) {
								field_320[method_149(this.field_214)].drawFrame(var1, this.field_215, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_290, 0, 0);
							} else {
							...
							if (this.field_285 != -1) {
								field_324.drawAnimFrame(var1, this.field_285, this.field_286, this.field_271 + this.field_288, this.field_272 + this.field_289, 0, 0, 0);
								this.field_285 = -1;
							}
					...
					if (this.field_283 != -1) {
						...
						if (this.field_216 != -1) {
							if (field_318[this.field_216] == null) {
								field_320[method_149(this.field_216)].drawFrame(var1, this.field_217, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_290, 0, 0);
							} else {
							...
							if (this.field_285 != -1) {
								field_324.drawAnimFrame(var1, this.field_285, this.field_286, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_287, 0, 0);
								this.field_285 = -1;
							} else {
								field_324.drawFrame(var1, this.field_286, this.field_271 + this.field_288, this.field_272 + this.field_289, this.field_287, 0, 0);
							}
		...
		if (field_367) {
			...
			if (this.field_162 != this.field_163) {
				...
				while(true) {
					...
					var49.drawAnimFrame(var52, var55, var57, var4, var5, 0, 0, 0);
					++var3;
					var48 = var3 & 7;
				}
			}
							...
							label284: {
								...
								if (var5 >= 20 && var5 < 26) {
									...
									case 31:
										...
										var14.drawAnimFrame(this.field_314, var13, var15, var10, var11, 0, 0, 0);
										break;
									case 32:
										field_320[16].drawAnimFrame(this.field_314, 0, field_332[var37][var39] >> 8 & 255, var10, var11, 0, 0, 0);
										break;
									case 36:
										int var12 = (field_332[var37][var39] >> 8) - 1;
										var12 = (0 + var12 * 7) / 16;
										field_320[20].drawAnimFrame(var1, 0, var12, var10, var11, 0, 0, 0);
										break;
									default:
										byte var16;
										if ((var16 = (byte)(var5 - 80)) >= 0) {
											field_320[42].drawFrame(var1, var16, var10, var11, 0, 0, 0);
										}
									}
								...
								var44.drawAnimFrame(var10001, var10002, var10003, var10, var11, 0, 0, 0);
							}

							if (var6 == 54) {
								field_320[7].drawAnimFrame(var1, 0, method_204(field_320[7], 0, field_333[var37][var39]), var10, var11, 0, 0, 0);
							}
						}
					}
				}
			...
			if (this.field_162 != this.field_163) {
				...
				while(true) {
					...
					var46.drawAnimFrame(var50, var53, var56, var4, var5, 0, 0, 0);
					++var3;
					var45 = var3 & 7;
				}
			}
			...
			if (this.field_257 > 0) {
				...
				if (field_364 != null) {
					if (this.field_365 != -1) {
						field_364.drawAnimFrame(var1, this.field_365, this.field_363, (this.field_359 - this.field_402) * 24 - this.field_404, (this.field_360 - this.field_403) * 24 - this.field_405, this.field_287, 0, 0);
					} else {
						field_364.drawFrame(var1, this.field_363, this.field_362, this.field_361, this.field_287, 0, 0);
					}
				}
	...
	private void method_154() {
		...
		int var5 = (frameCounter >> 1) % field_320[2].getAnimFrames(1);
		...
		for (int var6 = 0; var6 < field_192.length; var6 += 3) {
			...
			if ((var9 = (var8 = field_192[var6 + 2]) * 24) > var1 && var9 < var2) {
				...
				if (var12 >= var3 && var12 <= var4 || var13 >= var3 && var13 <= var4 || var12 <= var3 && var13 >= var4) {
					...
					if (var16) {
						field_320[2].drawAnimFrame(this.field_314, 1, var5, var14, var19, 1, 0, 0);
					} else if (var18) {
						field_320[2].drawAnimFrame(this.field_314, 1, var5, var17, var19, 0, 0, 0);
					}
				}
			}
		}
	...
	private void method_158() {
		...
		if ((field_333[this.processedTileX][this.processedTileY] & 8) == 0) {
			...
			this.field_288 = field_324.animFrames[var2 + 2];
			this.field_289 = field_324.animFrames[var2 + 3];
		}
	}
	...
	private void method_159() {
		...
		if (this.field_285 != 8 && this.field_285 != 9) {
			...
			this.field_288 = field_324.animFrames[var3 + 2];
			this.field_289 = field_324.animFrames[var3 + 3];
		} else {
			this.field_286 = 0;
			int var1 = (field_324._anims_af_start[this.field_285] + 0) * 5;
			this.field_288 = field_324.animFrames[var1 + 2];
			this.field_289 = -field_335[this.processedTileX][this.processedTileY];
		}
	...
	private void method_160() {
		...
		case 1:
			this.field_286 = (field_335[this.processedTileX][this.processedTileY] >> 1) % field_320[27].getAnimFrames(1);
			break;
		case 3:
			this.field_286 = 0;
			this.field_289 = -field_335[this.processedTileX][this.processedTileY];
					...
					if (var6 > 0) {
						for (byte k = 0; k <= 2; k++) {
							if (method_373(var6, k, (byte)0, (byte)3) != 0) {
								var12 = (byte)(method_373(var6, k, (byte)7, (byte)2) << 3);
								if (var12 > 0) {
									var12 = method_375(method_373(var6, k, (byte)0, (byte)3), (byte)45, (byte)2) <= 1 ? (byte)(var12 - 24) : (byte)(24 - var12);
									this.method_152();
									var3.clipRect(var10, var11 + (k << 3), 24, 8);
								}

								int var14 = this.method_396(var7, var8, var6, k);
								int var15 = var14 >> 1;
								int var16 = (var15 == 7 ? frameCounter >> 3 : frameCounter) & 1;
								if (var15 == 15) {
									field_499.drawFrame(var3, var14 + this.field_393, var10 + var12 - 8, var11 + (k << 3) + 8, 36, 0, 0);
									this.field_393++;
									if (this.field_393 > 2) {
										this.field_393 = 0;
									}
									...
									if (var15 != 14 && var15 != 11) {
										if (var15 == 8 && k == 0 && field_500[var7][var8 - 1] > 0) {
											field_499.drawFrame(var3, 33, var10 + var12, var11, 20, 0, 0);
											k = 3;
										} else {
											field_499.drawFrame(var3, var14 + var16, var10 + var12, var11 + (k << 3), 20, 0, 0);
											this.method_152();
										}
									} else {
										field_499.drawFrame(var3, var14 + var16, var10 + var12, var11, 20, 0, 0);
										this.method_152();
									}
								}
							}
	...
	private void method_165(int var1) {
		...
		if (field_320[var3] != null) {
			field_320[var3].drawAnimFrame(this.field_314, 0, var2, this.field_271, this.field_272, 0, 0, 0);
		}
	...
	private void method_166() {
		...
		if ((var3 = field_320[0]) != null) {
			...
			if (!this.field_170 && gameState != 2) {
				var1 = true;
				var2.setClip(-120, -320, 240, 320);
			} else {
				var3.drawFrame(var2, 0, 0, 0, 0, 0, 0);
				if (this.field_417) {
					var3.drawFrame(var2, 19, 0, 0, 0, 0, 0);
				}
			}

			var3.drawFrame(var2, 1, 0, 0, 0, 0, 0);
			if (this.field_179) {
				var3.drawFrame(var2, 2, 2, 0, 0, 0, 0);
				var3.drawFrame(var2, 3 + this.field_178, 2, 0, 0, 0, 0);
			}
			...
			boolean var10 = false;
			if (this.field_170 || gameState == 2) {
				var3.drawFrame(var2, 20, 0, 0, 0, 0, 0);
				var10 = true;
			}

			if (this.field_415 != this.playerGoldKeys || this.field_416 != this.playerSilverKeys || this.field_170 || gameState == 2 || var10) {
				if (!var10) {
					var3.drawFrame(var2, 20, 0, 0, 0, 0, 0);
					var10 = true;
				}
	...
	private void method_168() {
		...
		var2.drawAnimFrame(this.field_314, var1, (frameCounter >> 1) % var2.getAnimFrames(var1), this.field_271, this.field_272, 0, 0, 0);
	}
	...
	private void method_173(int var1, int var2) {
		if (gameState == 4) {
			this.drawSplash(this.field_314, false);

			for (int var3 = var1 - 1; var3 < var2 - 2; ++var3) {
				field_320[18].drawFrame(this.field_314, 4, var3 % 2, var3, 0, 0, 0);
			}
		}
	...
	private void method_175() {
		...
		int var1 = 320 - (this.crtMenuItems * 15 + 1 + 2);
		var1 += (!this.field_432 && this.crtMenu == 0 ? 15 : 0);
		int var2 = 320;
		this.field_314.setClip(0, 0, 240, 320);
		if (gameState == 2 && field_429 && field_430) {
		...
		// Center menu if in pause menu or in the initial sound menu
		if (gameState == 7 || gameState == 2) {
		...
		for (int i = 0; i < this.crtMenuItems; i++) {
			if ((this.field_427 == -1 || i == this.field_427 || i == this.currentMenuSelection || field_429) && (this.crtMenu != 0 || i != 1 || this.field_432)) {
				...
				if (i == this.currentMenuSelection) {
					this.field_314.setColor(0xFFFFFF);
					field_320[18].drawFrame(this.field_314, 2, 120 - var9 / 2 - 8, var7, 0, 0, 10);
					field_320[18].drawFrame(this.field_314, 2, 120 + var9 / 2 + 8, var7, 0, 0, 6);
				}
		...
		if (this.crtMenu == 0 && this.field_473) {
			if (this.field_418 % 20 >= 10) {
				field_320[18].drawFrame(this.field_314, 1, 1, var1 + 30 + 7 - (this.field_432 ? 0 : 15), 0, 0, 6);
				...
				if (field_428 == null) {
					...
					for (int i = 0; i < 14; i++) {
						field_320[18].drawFrame(var21, 4, (var20 + i + 1) % 2, i, 0, 0, 0);
					}
				}
	...
	public final void drawBackButton() {
		field_320[18].drawFrame(this.field_314, 0, 223, 308, 0, 0, 0);
	}

	// $FF: renamed from: b () void
	public final void drawOKButton() {
		field_320[18].drawFrame(this.field_314, 3, 2, 308, 0, 0, 0);
	}
	...
	private void renderProgressBar() {
		...
		var1.fillRect(0, 0, 240, 320);
		int barWidth = (this.assetsLoaded + 1) * 230 / this.assetsTotal;
		if (barWidth > 230) {
			barWidth = 230; // Bar is 230 pixels wide
		}
	...
	private void method_180() {
		if (this.field_201 + 240 > 1440 && this.field_202 + 320 > 48) {
			...
			if (this.method_298(60, 3) || this.method_298(61, 3)) {
				var1.drawFrame(this.field_314, 1, 1440 - this.field_201, 48 - this.field_202, 0, 0, 0);
			}
		}
	...
	private void method_181(Graphics var1) {
		...
		if (this.processedTileX >= 60 && this.processedTileX < 65 && this.processedTileY >= 2 && this.processedTileY < 7) {
			field_320[10].drawFrame(var1, 4 + (this.processedTileY - 2) * 5 + this.processedTileX - 60, this.field_271, this.field_272, 0, 0, 0);
		}
	...
	private void method_182() {
		if (this.field_180 != -1) {
			...
			if (this.field_180 == 12) {
				...
				field_320[7].drawAnimFrame(this.field_314, 0, frameCounter % field_320[7].getAnimFrames(1), var2, var3, 0, 0, 0);
	...
	private void method_183() {
		...
		if (this.field_180 != 15) {
			...
			if (this.field_180 == 12) {
				...
				field_320[7].drawAnimFrame(this.field_314, 0, frameCounter % field_320[7].getAnimFrames(0), var4, var2, 0, 0, 0);
	...
	private void method_184() {
		...
		if (this.field_180 == 7) {
			...
			field_320[7].drawAnimFrame(var1, 1, frameCounter % field_320[7].getAnimFrames(1), var3, var4, 0, 0, 0);
	...
	private void method_186() {
		...
		for (int i = 0; i < 3; i++) {
			...
			if (var6 < 240 && var6 > -48 && this.field_202 > -80) {
				field_320[40].drawFrame(var1, 1, var6, 216 - this.field_202, 0, 0, 0);
			}
		}
		...
		if ((this.field_176 >= 816 || var9._nCrtAnim == 2) && this.field_176 > 816) {
			for (int i = var5 + 20; i < 320; i += 24) {
				for (int j = var6; j < var8; j += 24) {
					var9._sprite.drawAnimFrame(this.field_314, 1, ((var1 >> 1) + j + i) % 2, j, i, 0, 0, 0);
				}
			}
		}
	...
	private void method_189() {
		if (this.field_189 && this.field_354 == null && this.field_258 == -1) {
			field_320[15].drawAnimFrame(this.field_314, 0, frameCounter >> 1 & 3, this.field_269, this.field_270 - 24, 0, 0, 0);
		}
		...
		if (!this.field_338) {
			...
			if (this.field_100) {
						...
						if (var6._nCrtAFrame > (var14 == 40 ? 13 : 6) || var14 == 47) {
							try {
								...
								if (field_318[this.field_210] == null) {
									field_320[method_149(this.field_210)].drawFrame(this.field_314, this.field_211, var6._posX + var16, var6._posY - 24, 0, 0, 0);
								} else {
				...
				if (var7 && field_334[var1][var2] == 0) {
					...
					try {
						field_320[method_149(1)].drawFrame(this.field_314, 0 + (field_333[var1][var2] & 56), var1 * 24 - this.field_201 + field_325[var15] * var17, var2 * 24 - this.field_202 + field_325[var15 + 8] * var17, 0, 0, 0);
						return;
	...
	private void method_193() {
		...
		if (((var6 = (var3 & 28672) >> 12) != 2 && var6 != 4 && var5 != 2 && var5 != 4 || field_334[var1 - 1][var2] < 0 || field_334[var1 + 1][var2] < 0) && (var6 != 1 && var6 != 3 && var5 != 1 && var5 != 3 || field_334[var1][var2 - 1] < 0 || field_334[var1][var2 + 1] < 0)) {
			...
			this.field_286 = (frameCounter >> 1) % field_324.getAnimFrames(this.field_285);
		} else {
			this.field_285 = 1;
			this.field_286 = 0;
		}
	...
	private void method_194(byte var1) {
		...
		var7.field_286 = var9 % var10002.getAnimFrames(var10003);
		this.method_156();
	}
	...
	private void method_196() {
		...
		if (var1 != 14 && var1 != 33 || var2 > 11) {
			...
			if (var1 == 14) {
				this.field_289 = -(field_320[8].getAnimFrames(0) - var2);
			} else if (var1 == 33) {
				this.field_289 = -(field_320[22].getAnimFrames(0) - var2);
			}
	...
	private void method_198() {
		...
		if (var3 > 0) {
			field_323[0]._sprite.drawModule(this.field_314, this.field_286, var2, this.field_272 + 12 - 2, 0);
		}
	...
	private void method_200() {
		...
		if ((field_332[var1][var2 - 1] & 255) != 9 && (field_332[var1][var2 - 1] & 255) != 8) {
			field_320[56].drawFrame(this.field_314, var4, this.field_271, this.field_272, 0, 0, 0);
		}
	...
	private void method_202() {
		if (field_334[this.processedTileX][this.processedTileY + 1] != 16) {
			...
			this.field_288 = var2.animFrames[var7 + 2];
		}
	}
	...
	private void method_203() {
		...
		if (this.field_285 == 10) {
			int var3 = var2;
			int var4 = 0;
			int var6 = field_324.getAnimFrames(this.field_285);
			...
			this.field_288 = field_324.animFrames[var8 + 2];
			this.field_289 = field_324.animFrames[var8 + 3];
		}
	...
	private void method_206() {
		...
		if (var4 == 10) {
			...
			int var7 = field_320[28].getAnimFrames(var4);
	...
	private void method_207() {
		...
		for (int i = 0; i < var4; i++) {
			field_320[11].drawFrame(this.field_314, var2 + i * var1, this.field_271 + 3, this.field_272 + var1 * (var5 - i * 24), 0, 0, 0);
		}

		if (var1 == 1) {
			field_320[42].drawFrame(this.field_314, field_334[this.processedTileX][this.processedTileY - 1] - 80, this.field_271, this.field_272 - 24, 0, 0, 0);
		} else {
			field_320[42].drawFrame(this.field_314, field_334[this.processedTileX][this.processedTileY + 1] - 80, this.field_271, this.field_272 + 24, 0, 0, 0);
		}
	}
	...
	private void method_208() {
		...
		if (frameCounter > 30) {
			...
			if (var4 > 29) {
				...
				if (frameCounter < 42) {
					...
					var1._sprite.drawFrame(this.field_314, 10, 138, 136 + var3, 0, 0, 0);
				} else {
					var1._sprite.drawFrame(this.field_314, 4, 138, 136, 0, 0, 0);
				}

				var1._nCrtAFrame = 0;
			} else {
				var1._sprite.drawFrame(this.field_314, 10, 138, 136, 0, 0, 0);
			}
		...
		var1._posY += var3;
		var1.PaintSprite(this.field_314);
		var1._sprite.drawFrame(this.field_314, 5, 138, 160 + var3, 0, 0, 0);
	}
	...
	private static int canBuyItem(int item) {
		if (recordData[8] >= 4 + item + 1) {
			return 0; // Return if the item or an item better than it was already bought
		} else {
			return getShortFromBytes(recordData, 4) < Define.itemPrices[item] ? -1 : 1;
		}
	}
	...
	private void method_214(int var1) {
		...
		case 0:
			...
			return;
		case 1:
			this.collectedDiamonds = getShortFromBytes(recordData, 4) - Define.itemPrices[this.field_97];
			this.field_555 = null;
			System.gc();
			this.field_555 = menuText[110] + " " + this.collectedDiamonds + " " + menuText[109];
			recordData[4] = (byte)(this.collectedDiamonds & 255);
			recordData[5] = (byte)(this.collectedDiamonds >> 8 & 255);
			recordData[8] = (byte)(4 + var1 + 1);
			this.method_110();
			this.field_98 = -1;
			this.field_99 = menuText[81];
			this.field_435 = true;
	...
	private void checkCheatKeyCodeIsPressed() {
		if (crtCheatKeyCodeIndex < cheatPageKeyCode.length && isKeyPressed(cheatPageKeyCode[crtCheatKeyCodeIndex])) {
			...
			if (crtCheatKeyCodeIndex == cheatPageKeyCode.length) {
				keysPressed = 0;
				gameState = 24;
				this.field_389 = recordData[8];
				this.field_390 = recordData[9];
	...
	// $FF: renamed from: aU () void
	// Handle seal menu logic
	private void method_221() {
		if (this.field_123 == -1 && this.field_118 == 0) {
			// Enter store or level select page
			if (isKeyPressed(SKEY_NUM5|SKEY_CENTER_ALT|SKEY_CENTER|SKEY_LSH)) {
				this.sealArrowMoveDirection = 4;
			} else {
				// Back to main menu
				if (isKeyPressed(SKEY_RSH)) {
					this.method_95();
				...
				// Set direction for seal's arrow move
				if (isKeyPressed(SKEY_NUM2|SKEY_UP)) {
					this.sealArrowMoveDirection = 0;
				} else if (isKeyPressed(SKEY_NUM8|SKEY_DOWN)) {
					this.sealArrowMoveDirection = 2;
				} else if (isKeyPressed(SKEY_NUM4|SKEY_LEFT)) {
					this.sealArrowMoveDirection = 3;
	...
	private void method_223() {
		...
		} else if (isKeyPressed(SKEY_NUM5)) {
			gameState = 34;
		} else if (isKeyPressed(SKEY_NUM0)) {
			this.field_392 = !this.field_392;
		} else {
			if (!isKeyPressed(SKEY_RSH)) {
				if (isKeyPressed(SKEY_NUM5|SKEY_CENTER_ALT|SKEY_CENTER|SKEY_LSH)) {
					recordData[8] = (byte)this.field_389;
					recordData[9] = (byte)this.field_390;
	...
	// $FF: renamed from: aY () void
	// Handles the logic for the debug screen
	private void debugScreenLogic() {
		byte upperLimit = 0;
		int var2 = 0;
		...
		if (isKeyPressed(SKEY_NUM2|SKEY_UP)) {
			this.debugScreenMode--;
			if (this.debugScreenMode < 0) {
				this.debugScreenMode = 0;
			}
		}
		...
		if (isKeyPressed(SKEY_NUM8|SKEY_DOWN)) {
			this.debugScreenMode++;
			if (this.debugScreenMode >= 2) {
				this.debugScreenMode = 1;
			}
		}

		var2 = this.debugScreenSels[this.debugScreenMode];
		...
		switch (this.debugScreenMode) {
		case 0:
			upperLimit = 115; // Amount of text entries
			break;
		case 1:
			upperLimit = 8; // Amount of tips
			break;
		default:
			break;
		}
		...
		this.debugScreenSels[this.debugScreenMode] = var2;
		keysPressed = 0;
	}
	...
	private void method_236() {
		...
		if (this.field_162 != this.field_163) {
			for (int i = this.field_162; i != this.field_163; i = i + 1 & 7) {
				field_160[i]++;
				int var14 = field_161[i] < 0 ? method_313(field_320[2], 0) : field_320[9].getAnimFrames(field_161[i]);
					...
					if (!var13 && this.field_197 != 5 && this.field_232 <= 0 && (var20 == 0 || var20 == 9 || var20 == 8 || var20 == 48) && (field_332[this.playerXPos][this.playerYPos] & 255) != 35) {
						...
						if (!this.field_155 || var24 == 0 && var24 != 3) {
							...
							if (this.field_93 <= 0) {
								this.field_93 = 40;
								this.field_241 = 0L;
								this.method_61(recordData[8], 32, 0);
								return;
							}
						}
					}
	...
	private void method_242() {
		...
		case 5: {
			if (this.field_248 == 0) {
				if ((this.field_445 & 0x20) != 0x0) {
					...
					final ASprite a3;
					if (am == 5 && cGame.frameCounter < (a3 = cGame.field_320[9]).getAnimFrames(0) * 2) {
						a3.drawAnimFrame(a2, 0, cGame.frameCounter * 2, 200, 237, 0, 0, 0);
					}
				}
		...
		case 4: {
			...
			cGame.field_323[0]._sprite.drawAnimFrame(a2, 12, 0, 7 + n, 243, 0, 0, 0);
			...
			if (this.field_247 == 0) {
				if ((this.field_445 & 0x10) != 0x0) {
					...
					final ASprite a4;
					if (am == 4 && cGame.frameCounter < (a4 = cGame.field_320[9]).getAnimFrames(0) * 2) {
						a4.drawAnimFrame(a2, 0, cGame.frameCounter >> 1, 200, 179, 0, 0, 0);
					}
				}
		...
		case 3: {
			...
			cGame.field_323[0]._sprite.drawAnimFrame(a2, 10, 0, 7 + n2, 189, 0, 0, 0);
			...
			if (this.collectedRedDiamonds == this.levelRedDiamondCount) {
				if ((this.field_445 & 0x8) != 0x0) {
					...
					final ASprite a5;
					if (am == 3 && cGame.frameCounter < (a5 = cGame.field_320[9]).getAnimFrames(0) * 2) {
						a5.drawAnimFrame(a2, 0, cGame.frameCounter >> 1, 200, 121, 0, 0, 0);
					}
				}
		...
		case 2: {
			...
			cGame.field_320[method_149(3)].drawFrame(a2, 0, 7 + n3, 127, 0, 0, 0);
			...
			if (this.collectedDiamonds == this.levelDiamondCount) {
				if ((this.field_445 & 0x4) != 0x0) {
					...
					final ASprite a6;
					if (am == 2 && cGame.frameCounter < (a6 = cGame.field_320[9]).getAnimFrames(0) >> 1) {
						a6.drawAnimFrame(a2, 0, cGame.frameCounter * 2, 200, 63, 0, 0, 0);
					}
				}
		...
		case 1: {
			...
			cGame.field_320[method_149(2)].drawFrame(a2, 0, 7 + n4, 69, 0, 0, 0);
	...
	private static int addShortInRecord(int index, int addend) {
		int addedValue;
		if ((addedValue = getShortFromBytes(recordData, index) + addend) < 0) {
			addedValue = 0; // Limit to zero
		}

		recordData[index] = (byte)(addedValue & 255);
		recordData[index + 1] = (byte)(addedValue >> 8 & 255);
		return addedValue;
	}
	...
	private void method_249(int var1) {
		...
		case 0:
			...
			return;
		case 1:
			field_441 = getShortFromBytes(recordData, 4);
			field_441 += this.collectedDiamonds;
			this.field_225 = false;
			return;
		case 2:
			recordData[4] = (byte)(field_441 & 255);
			recordData[5] = (byte)(field_441 >> 8 & 255);
			return;
		case 3:
			field_442 = getShortFromBytes(recordData, 6);
			field_442 += this.collectedRedDiamonds;
			return;
		case 4:
			recordData[6] = (byte)(field_442 & 255);
			recordData[7] = (byte)(field_442 >> 8 & 255);
			return;
		case 5:
			field_443 = recordData[2];
			this.field_143 = 0;
		...
		case 8:
			...
			if (var2 < var3) {
				recordData[2] &= (byte)-225;
				recordData[2] |= (byte)(var3 << 5 & 224);
				this.method_110();
				this.field_144 = var3;
			}
		case 9:
			...
			if ((var3 & 240) != 0) {
				if (field_334[var1][var2] != 32) {
					...
					if (this.method_298(var1, var2)) {
						this.field_241 = 0L;
						this.field_254 = 0;
						this.method_61(recordData[8], 48, 0);
						this.method_433(cSoundEngine.SOUND_SFX_DEATH);
					} else {
						switch (field_334[var1][var2]) {
						case 0:
					...
					case 29:
						if (!var6) {
							if ((this.field_233 & 8192) == 0 && var2._nCrtAFrame == 2 && var2._nCrtTime == 0) {
								...
								if (recordData[9] >= 8 && var2._nCrtAFrame == 2 && var2._nCrtTime == 0) {
	...
	private void method_270() {
		...
		if (this.playerXPos == var1 || this.playerXPos == var1 + 1) {
			...
			var5 = (var2._sprite.animFrames[var5 + 3] << 0) * 1 / 1;
			var3 -= var5;
			var4 -= var5;
			int var6;
	...
	private int method_275() {
		...
		var3 = (var1._sprite.animFrames[var3 + 3] << 0) * 1 / 1;
	...
	private void method_278() {
		...
		case 4:
			...
			if (this.field_181 >= var7) {
				...
				this.field_181 = 0;
				var2 = 4;
			} else if (this.field_181 > var7 >> 1 && var1._nCrtAnim != 1) {
				var2 = 1;
			}
		...
		case 5:
			...
			var9 = (var1._sprite.animFrames[var9 + 3] << 0) * 1 / 1;
		...
		case 9:
			...
			var11 = (var1._sprite.animFrames[var11 + 3] << 0) * 1 / 1;
	...
	private void method_282() {
		...
		for (int i = 15; i <= 22; i++) {
			for (int j = 14; j <= 21; j++) {
				if ((j <= var4 || j >= var5 || i <= var6 || i >= var7) && field_334[j][i] == 44) {
					this.field_279 = j;
					this.field_280 = i;
					this.method_314();
				}
		...
		if (this.field_180 == 12) {
			...
			if (this.field_453 == 0L && this.field_239 != 0) {
				this.field_453 = (long)(frameCounter + Utils.getRandomInt(340, 441));
			}
	...
	private void method_283() {
		...
		if (this.field_177 == 3) {
			if (field_323[2]._nCrtAnim != 0) {
				...
				field_323[2].SetAnim(1);
			}
		} else if (field_323[2]._nCrtAnim != 0) {
			field_323[2].SetAnim(0);
		}
		...
		if (field_323[2]._nCrtAnim == 2) {
			...
			if (field_323[1]._nCrtAnim == 0) {
				...
				if (this.crtLevelHeight * 24 - this.field_176 <= this.playerYPos * 24 + 18 && this.playerXPos < 17) {
					this.method_61(recordData[8], 64, 1);
					return;
				}
	...
	private void method_284() {
		if (field_332 != null && this.playerPosInBounds() && (field_332[this.playerXPos][this.playerYPos] & 255) == 0) {
			int var1 = field_332[this.playerXPos][this.playerYPos] >> 8;
			if (var1 == 13) {
				this.field_186 = true;
			} else if (var1 == 16) {
				this.field_187 = true;
	...
	public final void method_285() {
		...
		} else if (var2 > this.field_203 + 120) {
		...
		int var6 = this.playerYPos * 24 + this.field_232 * field_325[var1 + 8] + 40;
		if (var6 < this.field_204 + 96) {
	...
	private boolean method_288(int var1, int var2, boolean var3) {
		...
		if (var13 >= 0 && var13 < this.crtLevelWidth && var14 >= 0 && var14 < this.crtLevelHeight) {
			if (field_500 != null && field_500[var13][var14] != 0 && recordData[10] == 0) {
				var15 = false;
	...
	public final void method_291() {
		...
		if ((gameState == 30 || gameState == 4) && cSoundEngine.method_60()) {
			this.field_456 = true;
		}
	...
	private void method_296() {
		...
		int var5 = 0;
		int var6 = 0;
		this.hasLockedGoldenGateInLevel = false;
		this.hasLockedSilverGateInLevel = false;
				...
				if (var10 != -1) {
					label377:
						...
						case 7:
							...
							break;
						case 8:
							this.hasLockedSilverGateInLevel = true;
						case 9:
							if ((var10 & 255) != 8) {
		...
		if ((this.field_327 & (1L << 32)) != 0L || recordData[9] >= 8) {
			this.field_327 |= (1L << 40);
			this.field_327 |= (1L << 1);
			this.field_327 |= (1L << 0);
	...
	private static int method_313(ASprite var0, int var1) {
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			var2 += var0.animFrames[(var0._anims_af_start[var1] + var4) * 5 + 1] & 255;
		}
	...
	private void method_314() {
		...
		case 4:
			...
			++field_335[var1][var2];
			if (field_335[var1][var2] != field_320[27].getAnimFrames(4)) {
				return;
			}
	...
	private void method_315() {
		...
		int var10001;
		int var10002;
		if (var1 == field_320[16].getAnimFrames(0)) {
			...
			if ((var4 = field_332[var2][var3] & 255) != 14 && var4 != 33 || field_332[var2][var3] >> 8 != 255) {
				label38: {
					...
					case 6:
						...
						break;
					case 7:
						if (this.field_239 == recordData[8]) {
	...
	private void method_326() {
		...
		int var10001;
		int var10002;
		if (var1 >= field_320[13].getAnimFrames(0)) {
			var10000 = field_332[this.field_279];
			var10001 = this.field_280;
	...
	private void method_342(int var1) {
		...
		if (field_335[var2][var3] <= 0) {
			...
			} else if ((frameCounter >> 1 & 1) == 0 && field_320[var1 == 14 ? 8 : 22] != null && var4 < field_320[var1 == 14 ? 8 : 22].getAnimFrames(0) - 1) {
	...
	private static Image[] loadSpritesFromFile(String path, int fileNum, int palette) {
		...
		try {
			...
			freeSpriteCache(bitmapGfx, false);
			System.gc();
		} catch (Exception var5) {
		}
	...
	private static int getFrameHeightFromSprite(ASprite sprite, int frameIndex) {
		...
		return sprite.frameRects[offset] & 255;
	}
			...
			if (var6 == var2) {
				...
				label35: {
					...
					if (field_322[var22++] == 0) {
						...
						if (!var5) {
							tipSprite.drawFrame(var3, var25, (240 - tipSprite.frameRects[(var25 << 2) + 2] & 255) >> 1, var4, 0, 0, 0);
						}

						var10000 = var4;
						var27 = tipSprite.frameRects[(var25 << 2) + 3] & 255;
					}
	 ...
	 * @param fontSpr Font sprite
	 * @param text Dialog string
	 * @param x X position
	 * @param y Y position
	 * @param anchor The anchor flags to be used for drawing
	 * @param lineSpacing Set line space
	 * @param firstLineOnly Unknown
	 */
	private static void renderDialog(Graphics g, ASprite fontSpr, String text, int x, int y, int anchor, int lineSpacing, boolean firstLineOnly) {
		fontSpr._nLineSpacing = lineSpacing;
		if (text.endsWith("\n")) {
		...
		if ((anchor & Graphics.BOTTOM) != 0) {
			borderY = y - textHeight;
		} else if ((anchor & Graphics.VCENTER) != 0) {
			borderY = y - (textHeight >> 1);
		}

		if ((anchor & Graphics.RIGHT) != 0) {
			borderX = x - textWidth;
		} else if ((anchor & Graphics.HCENTER) != 0) {
			borderX = x - (textWidth >> 1);
		}

		g.setColor(0x0C2F39); // Dialog background color
		g.fillRoundRect(borderX - 5, borderY - 5, textWidth + 10, textHeight + 10, 10, 10);
		g.setColor(0xCE9B00); // Dialog border color
		g.drawRoundRect(borderX - 5, borderY - 5, textWidth + 10, textHeight + 10, 10, 10);
		fontSpr.DrawPage(g, text, x, y, anchor);
	}
	...
	private int method_406(Graphics var1, byte[] var2, ASprite var3, int var4, int var5, int var6, ASprite var7, int var8, int var9) {
		int var10 = 0;
		var6 -= var3.frameModules[2];
		int var11 = var3._nLineSpacing + (var3.modules[1] & 255);
		int var12 = 0;
		int var13 = var6;
		...
		for (int var21 = var4; var21 <= var4 + var5; ++var21) {
			...
			if (var17 && var12 > var9) {
				...
				if (var17 && var14) {
					...
					var16 = var21 + 1;
					var13 += var11;
					var11 = var3._nLineSpacing + (var3.modules[1] & 255);
				}
				...
				label105: {
					...
					if (var22 > 32) {
						if (var22 == 64 && var7 != null) {
							if (!var17 && var14) {
								var7.drawFrame(var1, var2[var10 + var8], var12, var13, 0, 0, 0);
							}
					...
					int var10002;
					if ((var22 = var10000[var30] & 255) >= var3.getFrameModules(0)) {
						int var26 = var22 - var3.getFrameModules(0);
						if (!var17 && var14) {
							var3.drawFrame(var1, var26, var12, var13, 0, 0, 0);
						}

						var28 = var12;
						var30 = var3.frameRects[(var26 << 2) + 2] & 255;
						var10002 = var3.frameRects[var26 << 2] & 255;
					} else {
						int var27 = (var3.frameModules[var22 << 2] & 255) << 1;
						if (!var17 && var14) {
							var3.drawFrameModule(var1, 0, var22, var12, var13, 0);
						}

						var28 = var12;
						var30 = var3.modules[var27] & 255;
						var10002 = var3.frameModules[(var22 << 2) + 1];
					}

					var30 -= var10002;
				}

				var12 = var28 + var30 + var3.frameModules[1];
			}
		}
	...
	private void method_407() {
		this.field_373 = false;
		freeSpriteCache(field_320[23], true);
		field_320[23] = null;
		freeSpriteCache(field_320[24], true);
		field_320[24] = null;
		freeSpriteCache(field_320[25], true);
		field_320[25] = null;
		freeSpriteCache(field_320[26], true);
		field_320[26] = null;
		freeSpriteCache(field_320[17], true);
		field_320[17] = null;
		this.field_544 = null;
	...
	private void method_414() {
		if (this.field_528 == this.field_530 && this.field_529 == this.field_531) {
			...
			if (field_320[17] != null) {
				field_320[17].drawFrame(this.field_314, 10, var11 + var7 - 2 - 14, var12 + 2 - 1, 0, 0, 0);
			}
	...
	private boolean method_416() {
		...
		for (int i = this.field_550 ? -1 : 1; var11 < this.field_546; var12 += i) {
			int var14 = var12 * 2;
			field_320[17].drawFrame(this.field_314, var9, this.field_544[var14], this.field_544[var14 + 1], 0, 0, 0);
			var11++;
		}
		...
		field_320[17].drawFrame(this.field_314, var20, var16, var17, 0, 0, 0);
		int var18 = this.field_527 ? 7 : 6;
		field_320[17].drawFrame(this.field_314, var18, var16 + 6, var17 + 6, 0, 0, 0);
		boolean var19 = true;
		if (var11 == var2) {
			if (this.field_549 < 0) {
				this.field_549 = 2;
		...
		if (!var19) {
			boolean var29;
			if (this.field_548 == field_320[9].getAnimFrames(0)) {
				this.field_548--;
				this.field_543 = true;
				var29 = true;
			} else {
			...
			var1 = var29;
			if (!this.field_384) {
				field_320[9].drawFrame(this.field_314, this.field_548, var16, var17, 0, 0, 0);
			}
	...
	private void method_417() {
		...
		if (this.field_528 == this.field_530 && this.field_529 == this.field_531) {
			if (this.field_558) {
				...
				field_320[17].drawFrame(this.field_314, var6, var1, var2, 0, 0, 0);
			}
		} else {
	...
	private boolean method_418(int var1, int var2, int var3, int var4) {
		...
		if (this.field_521 <= this.field_520) {
			...
			if (this.field_524 < 0 && this.field_517 <= var3 || this.field_524 > 0 && this.field_517 >= var3) {
				...
				field_320[17].drawFrame(this.field_314, var5, var3, var4, 0, 0, 0);
				this.field_526 = true;
				return true;
			}

			field_320[17].drawFrame(this.field_314, var5, this.field_517, this.field_518, 0, 0, 0);
					...
					if (this.field_537 <= this.field_536) {
						...
						while(true) {
							if (this.field_540 % 8 == 0) {
								field_320[17].drawFrame(field_514, var23, this.field_533 - 27, this.field_534 - 56, 0, 0, 0);
								if (this.field_542) {
	...
	private void method_422() {
		...
		case 0:
			bgColor = 0x0E5512;
			stageLabelColor = 0x2F7B46;
			stageLabelBorderColor = 0x83C42A;
			var5 = 24;
			worldName = 28;
			break;
		case 1:
			bgColor = 0x0D4351;
			stageLabelColor = 0x3D618A;
			stageLabelBorderColor = 0x59A0D2;
			var5 = 25;
			worldName = 29;
			break;
		case 2:
			bgColor = 0x4F818E;
			stageLabelColor = 0x38A1BD;
			stageLabelBorderColor = 0x71F9FF;
			var5 = 26;
			worldName = 30;
			break;
		default:
		...
		field_320[41].drawString(this.field_314, menuText[worldName], 8, 6, 20);
		field_514 = field_513.getGraphics();
		field_514.setColor(bgColor);
		field_514.fillRect(0, 0, 186, 226);
		field_320[23].drawFrame(field_514, 0, 93, 113, 0, 0, 0);
		this.field_314.setColor(stageLabelColor);
		this.field_314.fillRoundRect(2, 282, 236, 22, 8, 8);
		this.field_314.setColor(stageLabelBorderColor);
		...
		field_512.delete(0, field_512.length());
		field_512.append(getShortFromBytes(recordData, 4));
		field_320[41].drawString(this.field_314, field_512.toString(), 100, 285, 20);
		field_512.delete(0, field_512.length());
		int var6 = getShortFromBytes(recordData, 6);
		byte var8 = recordData[0];
		if (var6 >= var8) {
	...
	private void method_431() {
		if (this.field_97 != this.field_554 || this.field_557) {
			...
			if (this.field_557) {
				...
				if (this.field_98 != -1) {
					field_320[41].DrawPage(this.field_314, getWrapText(this.field_99, 200), 120, 280, 17);
				}
			...
			field_320[17].drawFrame(this.field_314, 14, 20, 43 + this.field_97 * 20 + 2, 0, 0, 0);
			...
			for (int var2 = 0; var2 < 4; ++var2) {
				var10 = 43 + 20 * var2;
				field_320[46].drawFrame(this.field_314, 0 + var2, 27, var10, 0, 0, 0);
	...
	private void method_437(String var1, int var2, int var3, int var4, int var5, int var6) {
		...
		this.field_570 = var2;
		this.field_571 = var3;
		this.field_569 = getWrapText(var1, 220);
		this.field_572 = var5;
		this.field_573 = var6;
	}
	...
	// $FF: renamed from: a (java.lang.String, int) java.lang.String
	// Create a string with word wrap
	// @param s String will modify
	// @param maxTextW Maximum width of a line of text
	public static String getWrapText(String s, int maxTextW) {
		ASprite fontSpr = field_320[41];
		int crtLineW = 0;
		int crtSpacePos = 0;
		int oldLineW = 0;
		int oldSpacePos = 0;
		...
		for (int i = 0; i <= strBuf.length(); i++) {
			int c = '\n';
			if (i < strBuf.length()) {
				c = strBuf.charAt(i) & 255;
			}

			// Check if the current width exceeds the maximum text width
			// If so, replace the nearest whitespace with line feed (LF)
			// to implement word wrap (it doesn't work if no new whitespace
			// find in text)
			if (crtLineW > maxTextW && crtSpacePos != oldSpacePos) {
				crtLineW = oldLineW;
				// replace current whitespace with line feed (LF)
				strBuf.setCharAt(crtSpacePos, '\n');
				// restore char pos
				i = crtSpacePos - 1;
				oldSpacePos = crtSpacePos;
			} else {
				if (c == '\n') {
					crtLineW = 0;
				} else {
					...
					if (c > ' ') {
						...
						c = ASprite._pMapChar[c] & 255;
						if (c >= fontSpr.getFrameModules(0)) {
							int fmoduleIndex = c - fontSpr.getFrameModules(0);
							// frame rect width
							charW = fontSpr.frameRects[(fmoduleIndex << 2) + 2] & 255;
							// frame rect x offset
							charW -= fontSpr.frameRects[fmoduleIndex << 2] & 255;
						} else {
							// module index
							int moduleIndex = (fontSpr.frameModules[c << 2] & 255) << 1;
							// module width
							charW = fontSpr.modules[moduleIndex] & 255;
							// fmodule x offset
							charW -= fontSpr.frameModules[(c << 2) + 1];
						}
					} else if (c == ' ') {
						crtSpacePos = i;
						oldLineW = crtLineW;
						// whitespace width
						charW = fontSpr.modules[0] & 255;
					}
					// whitespace x offset as character spacing
					crtLineW += charW + fontSpr.frameModules[1];
				}
			}
		}
